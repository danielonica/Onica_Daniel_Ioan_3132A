...
namespace Onica_Daniel_Ioan
{
    class CameraViz
    {
        ...
        public CameraViz(int _eyeX, int _eyeY, int _eyeZ, int _targetX, int _targetY, int _targetZ, int _upX, int _upY, int _upZ)
        {
        ...
        public CameraViz(Vector3 _eye, Vector3 _target, Vector3 _up)
        {
            eye = _eye;
            target = _target;
            up_vector = _up;
